...
%this simply removes the datapoints from spikerate figures that aren't 
%included in the the state duration parsweep data (i.e. removes datapoints
%with spikerate data and no duration data). 
