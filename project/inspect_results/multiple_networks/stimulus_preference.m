...
%---this plots figure 5, figure 5 supplementary, figure 6, figure 6 supplementary 
...
Sname = 'nets_D2t-slower_pref'; %job name
figdir = sprintf('figures_%s',Sname); %print figures to Results/x


make_my_figs(basedir,Sname,figdir,opt);
