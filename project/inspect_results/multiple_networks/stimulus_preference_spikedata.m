...
%---this plots figure 8, figure 8 supplementary (leave decision activity) 
...
opt.Tcourse = 'presw200to25'; %plotting window: 'preswitch' | 'all' | 'presw250to5' | 'presw150to25'
opt.treat_data = 'none'; %'base0'; % zscore | base0 | minmax | 'none'
opt.zoomed_fig = 'yes'; %'yes'|'no'; %ignore I-stay spiking for Y limits


Sname = 'nets_D2t-slower_spikedata';
figdir = sprintf('figures_%s',Sname);


netspiking_figure(basedir,Sname,figdir,opt)


%---you can loop over these options like so:
