...
%---this plots figure 7 by pulling specific plots from supplementary 
%figures 3 and 4 (and then replotting them). You must run stimulus_mixed.m
%first to process the data and generate supplementary figures 

basedir = '~/Desktop/rotation/project'; %project directory!
%specify the results directory where stimulus_mixed.m saved the .fig files, then specify those filenames 
