...
%This code show network characteristics in four paneled plot (Results
%figure 1). This requires saved datafiles from a diag_model() run (see show_new_behvior.m). 
...
%jobs = 3:10:53; %JID 444 is the example small dataset (for working out figures)
%jobs = 114:10:364; %JID 444 is the example small dataset (for working out figures)
jobs = 74:10:574;
